...
// 検出した平面の角の印象を和らげるためのぼかし効果をデモする plane visualizer
...
public class ARFeatheredPlaneMeshVisualizer : MonoBehaviour
{
    ...
    // スクリプトのインスタンスが生成された時に呼び出される（Startより前）
    void Awake()
    {
    ...
    ///
    // 検出平面にテクスチャを貼るためのUV座標を求める
    void GenerateBoundaryUVs(Mesh mesh)
    {
        // 検出平面を表す形状のメッシュの頂点数を取得する
    ...
    static List<Vector3> s_FeatheringUVs = new List<Vector3>(); // テクスチャ座標（UV）リスト

    static List<Vector3> s_Vertices = new List<Vector3>(); // 頂点座標リスト
